    ...
    fs.readFile(filePath, (err, content) => {
        if (err) {
            ...
            if (salonSlug && ext === '.html') {
                ...
                const extraHeaders = ext === '.html' ? SECURITY_HEADERS : {};
